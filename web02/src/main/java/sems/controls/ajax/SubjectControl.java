...
public class SubjectControl {
	...
	public AjaxResult list(
		...
		List<SubjectVo>list =  subjectService.list(pageNo, pageSize);
		return new AjaxResult().setStatus("ok").setData(list);
	}
	...
	public AjaxResult detail(int no, Model model) {
		...
		if (s != null) {
			return new AjaxResult().setStatus("ok").setData(subjectService.detail(no));
		}	else {
