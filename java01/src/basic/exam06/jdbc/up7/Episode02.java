...
class Patient02 {
	...
	// 프로퍼티 이름 => set/get을 뺴고 난 다음의 이름에서 첫 알파벳을 소문자로 한 것.
...
public class Episode02 {
	...
	public static void main(String[] args) {
		...
		p1.setName("홍길동");
		p1.setAge(-200); 					// 유효하지 않은 나이
		p1.setWeight(-90); 			// 유효하지 않은 몸무게
		p1.setHeight(280); 			// 유효하지 않은 키
		p1.setBloodType("X"); 	// 유효하지 않은 혈액형
