...
public class Episode01 {
	public static void main(String[] args) {
      ...
      public boolean equals(Object obj) {
	      ...
	      return true;
			...
			public MyKey(int no) {
				KeyNo = no; 		// this.KeyNo -> this. 가 생략되었다.
			}
		}
		
		MyKey k1 = new MyKey(100);
		
		// ===== HashMap<K, V> -> K(key) 값으로 쓸 수 있는것은 wrapper class 뿐이다.
		// ===== 그 외에 사용자 정의 key값을 사용하려면 hashCode()와 equals() 재정의가 필요하다.
		...
		if (k1 == k2) System.out.println("같다...");
		if (k1.equals(k2)) System.out.println("equals() 같다...");
		if (k1.hashCode() == k2.hashCode()) System.out.println("hash 같다...");
	...
	public static void main07(String[] args) {
		// HashMap의 key를 MyKey(직접 생성한 클래스)로 교체
		class MyKey {
			int KeyNo;
		...
		// 비록 내용은 같지만 hashCode와 equals() 가 재정의 되지 않았다.
	...
	public static void main06(String[] args) {
		...
		// .equals() hashCode()가 재정의 되었기 때문에 
		if (i1.equals(i2)) System.out.println("equals() 같다...");
		if (i1.hashCode() == i2.hashCode()) System.out.println("hash 같다...");
		...
		System.out.println("----- for (String name : map.values()) 사용 -----");
		for (String name : map.values()) {
			System.out.println(name);
		}
		
		System.out.println("----- for (String key : map.keySet()) 사용 -----");
	...
	public static void main04(String[] args) {
      ...
      public boolean equals(Object obj) {
		...
		if (s1.equals(s4)) System.out.println("s1 == equal(s4)");
		if (s1.hashCode() == s4.hashCode()) System.out.println("s1, s4 해시값 같다.");
	...
	public static void main03(String[] args) {
		...
		class Student {
			...
			public Student(String n, int age) {
				// 로컬 변수 이름과 겹치지 않는다면 this 생략 가능.
				/*this.*/name = n;
				this.age = age; 		// 로컬 변수 이름과 동일 => this 생략 불가능. 
			}
	...
	//// equals(), hashCode() 재정의 전 -> 같은 값이라도 다른 인스턴스이므로 중복 저장 됨
	//// HashSet의 장점 => 데이터가 중복 저장되지 않는다. -> HashSet의 용도에 맞지 않는다
	//// equals(), hashCode() 재정의 필요함
	...
	public static void main02(String[] args) {
		...
		//// String에는 equals(), hashCode() 재정의가 되어있기 때문에 중복 저장되지 않는다.
