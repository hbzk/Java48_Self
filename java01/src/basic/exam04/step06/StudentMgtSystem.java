...
public class StudentMgtSystem {
	...
	public static void executeList() {
		...
		// >> 넣을때 Generic으로 <StudentScore> 형식만 받았기 때문에 꺼낼때도 <StudentScore> 형식에 맞춰서 꺼낼 수 있다.
		int i = 0;
