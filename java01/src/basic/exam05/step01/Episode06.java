 ...
 * - 파일을 읽을 때 1바이트씩 읽는 것 보다 많이 읽는것이 더 빠르다.
 * - 파일 읽기 시간 = data seek time + data transfer time
 *  	-> data seek time : HDD 헤더를 움직여 데이터가 있는 트랙으로 이동한 후 트랙이 돌때 섹터를 찾는 것 까지의 시간.
 * 
 * 예) 1byte 읽는데 걸리는 시간 = data seek time (0.0085초) + data transfer time (0.000000003초)
 */
