 ...
 * - 출력 --> Unicode를 운영체제의 기본 인코딩으로 변환하여 출력한다.
...
public class Episode04 {
	...
	public static void main01(String[] args) throws Exception {
		// 텍스트 데이터 읽기를 통한 동작 비교
		// 바이너리 스트림으로 읽기
		// 읽어들인 데이터는 가공하지 않고, 원래의 바이트 그대로 리턴
		FileInputStream in = new FileInputStream("student4.dat");
		
		int i = 0;
		while ((i = in.read()) != -1) {			// Returns: the next byte of data, or -1 if the end of the file is reached.
			System.out.println(Integer.toHexString(i));
		}
		in.close();
	}
