...
public class StudentMgtSystem extends Frame {
	...
	public static final String STUDENT_PANEL = "Student Panel";
	...
	public StudentMgtSystem() { 	// > 생성자 재정의 (overloading)
		super("학생관리시스템"); 					// > java.awt.Frame.Frame(String title) 에 파라미터 전달
		setSize(400, 300);
