...
public class StudentMgtSystem04 extends Frame {
	...
	static Panel menuPanel = new Panel();
	
	public StudentMgtSystem04() {
		super("학생관리시스템"); 	// 수퍼클래스 생성자를 지정할 수 있다.
		// super(); 호출할 수퍼클래스 생성자를 지정하지 않는다면 기본 생성자 호출함
		// /*this.*/setTitle("학생관리시스템"); 	// 기본 생성자 호출 후 setTitle()를 호출해도 됨
