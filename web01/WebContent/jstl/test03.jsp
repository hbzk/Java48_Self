...
<body>
<%-- c:url 사용 --%>
<a href="http://localhost:9999/web01/subject/list.bit?pageNo=1&pageSize=10">과목목록</a><br>

<c:url var="listUrl" value="http://localhost:9999/web01/subject/list.bit?>">
	<c:param name="pageNo" value="1"/>
	<c:param name="pageSize" value="10"/>
</c:url>
<a href="${listUrl}">과목목록2</a>
<hr>
<%-- c:import
- 특정 URL의 콘텐츠 가져온다.
 --%>
