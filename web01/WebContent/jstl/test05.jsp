...
<title>c:parseDate, c:formatDate</title>
</head>
<body>

<%--
c:parseDate
- 문자열로부터 java.utl.Date 객체 생성
 --%>
...
<fmf:formatDate value="$(date2)" pattern="yyyy/MM'/dd"/><br>
<fmf:formatDate value="$(date2)" pattern="MM'/dd/yyyy"/><br>
<fmf:formatDate value="$(date2)" pattern="yyyy/MM'/dd"/ hh:mm:ss D/><br>
</body>
</html>